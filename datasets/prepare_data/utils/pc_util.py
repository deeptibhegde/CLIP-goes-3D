...
def draw_point_cloud(input_points, canvasSize=500, space=200, diameter=12,
...
def point_cloud_three_views_demo():
    ...
    filename = os.listdir('/media/SSD/3d/clasp_pointnet/ShapeNet55/shapenet_pc')[0]
    points = read_ply('/media/SSD/3d/clasp_pointnet/ShapeNet55/shapenet_pc/' + filename)
