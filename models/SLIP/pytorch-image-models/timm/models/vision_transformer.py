...
__all__ = ['VisionTransformer','VisionTransformerPrompt']  # model_registry will add each entrypoint fn to this
...
class VisionTransformerPromptDeep(nn.Module):
    """ Vision Transformer
...
class VisionTransformerPrompt(nn.Module):
    """ Vision Transformer
