...
from tools import finetune_multimodal
from tools import finetune_image
from tools import pretrain_CG3D_VPT
from tools import pretrain_CG3D
from tools import pretrain_CG3D_VPT_scanobjectnn
...
def main():
    ...
    if args.finetune:
        if args.depth:
            finetune_multimodal(args, config, train_writer, val_writer)
        elif args.finetune_image:
            finetune_image(args, config, train_writer, val_writer)
        else:
